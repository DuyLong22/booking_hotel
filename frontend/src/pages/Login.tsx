...
import { Sparkles, Mail, Lock, Eye, EyeOff, ArrowLeft, Home } from 'lucide-react';
    ...
    <div className="h-screen w-screen flex overflow-hidden bg-slate-50 font-sans">
      ...
      <div className="hidden md:flex md:w-1/2 relative flex-col justify-between p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 max-w-lg mb-12">
          <span className="inline-flex items-center gap-1 bg-amber-400/20 text-amber-300 font-extrabold text-[10px] px-3 py-1 rounded-full uppercase tracking-wider border border-amber-400/10">
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col justify-center items-center p-6 sm:p-12 md:p-16 bg-white overflow-y-auto">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center md:text-left space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight">Mừng bạn quay lại!</h2>
            <p className="text-xs text-slate-400 font-bold">Đăng nhập tài khoản CloudBooking để bắt đầu hành trình</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-700 font-bold text-xs py-2.5 px-4 border border-slate-200 rounded-xl transition-all shadow-sm active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-[#1877F2] hover:bg-[#166FE5] text-white font-bold text-xs py-2.5 px-4 rounded-xl transition-all shadow-sm active:scale-95"
            >
